  ...
  <div class="container-fluid">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Activity Lists</h3>
                <a href="{{Route('admin.create')}}/activity/create">  <i class="right fas fa-plus float-right"></i></a>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach($data as $row)
                       <?php $type=encrypt('activities,'.$row->id); ?>
                  ...
                  <tr>
                   ...
                   <td class="align-middle text-center">{{$row->sequence}}</td>
                     ...
                     <td class="align-middle  text-center">
                      <div class="btn-group ">
                         <a href="{{Route('admin.edit')}}/activity/edit/{{$row->id}}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                         <a href="{{Route('admin.status')}}/activity/{{$row->id}}" class="btn btn-info"><i class="fas <?php echo ($row->status=='1') ? 'fa-eye-slash' : 'fa-eye' ?>"></i></a>
